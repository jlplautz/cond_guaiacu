    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                this user has all permissions without explicitly assigning them.', verbose_name='superuser status')),
                ...
                this user.', related_name='user_set', related_query_name='user', to='auth.Permission', verbose_name='\
                user permissions')),
            ],
            options={
                'verbose_name': 'user',
            ...
            managers=[
                ('objects', GuaiAcu.base.models.UserManager()),
            ],
        ),
    ]
